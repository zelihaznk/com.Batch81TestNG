...
public class C02_WindowHandlesReusableMethod {
    ...
    public void test01() {
        ...
        theInternetPage.clickButton.click();
        ...
        //ReusableMethods.getSoftAssert().assertTrue(theInternetPage.newWindow.isDisplayed());
    ...
    public void test02() {
        ...
        //● Click Here butonuna basın.
        ReusableMethods.waitFor(3); //Burada bekleme yaptık
